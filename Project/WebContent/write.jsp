	...
	<!--------------------- 게시판 --------------------->
 	<div class="site-section" id="programs-section">
		<div class="container">
  		...
  		<!------ 글쓰기 ------>
         <form action="writePro.jsp" method="post" onsubmit="return validateForm(this);"  enctype="multipart/form-data">   
           <table class= "table table-stripped" boarder: 1px solid #dddddd">
            ...
            <div style="margin-left: 60%">
				 <input type="submit" value="완료"  class="btn btn-primary pull-right"> 
