<%-- 로그인하고도 로그인창이 나오면 이상하기 때문에 구현한 메인페이지2 --%>
	        ...
	        <div class="row">
	          <div class="owl-carousel col-12 nonloop-block-14">  
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_1.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	            ...
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_2.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	            ...
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_3.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	            ...
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_4.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	            ...
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_5.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	              <div class="course-inner-text py-4 px-4">
	                <span class="course-price">$99</span>
	                <h3><a href="#">Logo Design Course</a></h3>
	            ...
	            <div class="course bg-white h-100 align-self-stretch">
	              <figure class="m-0">
	                <a href="upload.jsp"><img src="images/img_6.jpg" alt="Image" class="img-fluid"></a>
	              </figure>
	              <div class="course-inner-text py-4 px-4">
	                <span class="course-price">$99</span>
	                <h3><a href="#">JS Programming Language</a></h3>
				...
				<div class="col-lg-7 text-center" data-aos="fade-up"
					...
					<div id="table_search" align="right">
						<form action="cousor-single.jsp" method="post">
							<select name="searchField" style="width: 60px; height: 30px;">
