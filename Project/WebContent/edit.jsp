	...
	<!--------------------- 게시판 --------------------->
 	<div class="site-section" id="programs-section">
		<div class="container">
 		...
 		<!----- 글수정 ----->
         <form action="editPro.jsp" method="post" onsubmit="return validateForm(this);">   
           <table class= "table table-stripped" style= "text-align: center; boarder: 1px solid #dddddd">
	    	 ...
	    	 <tbody>
               <tr>
                  <td>ID</td>
                  <td><input type="text" name="Id" value="<%=session.getAttribute("userID")%>" readonly> </td>
               </tr>
               <tr>
                  <td>PASS</td>
              ...
              <tr>
                  <td>File</td>
  					<td><input type="button" value="파일선택" onclick="location.href='upload.jsp'"><td>	
                  </td>
               </tr>      
               <tr>
                  <td>TITLE</td>
               ...
               <tr>
                  <td>CONTENT</td>
                  <td><textarea name="Content" rows="20" cols="100"><%=dto.getContent().replace("<br>", "\r\n")%></textarea></td>
               </tr>
               </tbody>
 			</table>
 			 <!----- 글수정 ----->   
