              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="updatePro.jsp" 
                    ...
                    <h3 class="h4 text-black mb-4">Changing Information</h3>
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" placeholder="password" 
                      		 value="<%=userPW%>" name="Pass" id="Pass">
                    </div>
                    <div class="form-group mb-4">
                      <input type="text" class="form-control" placeholder="name" 
                      		 value="<%=dao.getName(userID)%>" name="Name">
                    </div>
         			 <div class="form-group mb-4">
                    ...
                    <div>
                    	<input type="text"class="form-control"  id="sample2_detailAddress" placeholder="상세주소" name="addr3"> <BR>
                    </div>
                    <div>
                    	<input type="text" class="form-control" id="sample2_extraAddress" placeholder="참고항목" name="addr4"> <BR>
                    </div>              
                    <div class="form-group" align="center">
                      <input type="submit" class="btn btn-primary btn-pill" value="update" name="Btn">&nbsp;
                      <input type="reset" class="btn btn-primary btn-pill" value="reset">
                    </div>
                  </form>
